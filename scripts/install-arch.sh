...
pacman -Syu --needed zsh inetutils stow zsh-autosuggestions zsh-syntax-highlighting cmake nodejs-lts-jod npm python-pip fd ripgrep fzf luarocks tldr man-pages tmux neovim lazygit diff-so-fancy btop ncurses
pacman -Scc
chsh -s /usr/bin/zsh
mandb
reboot
